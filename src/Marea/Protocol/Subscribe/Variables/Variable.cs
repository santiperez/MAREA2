...
namespace Marea
{
    public class VariableImpl<T> : Variable<T>
    {
        ...
        public VariableImpl(ServiceAddress provider, String name) 
        {
        ...
        //public delegate void SubscriberChangeVariableDelegate(Variable<T> variable, bool isAdding, ServiceAddress id, NotifyFunc<T> notifyFunc, int totalSubscribers);
        //public SubscriberChangeVariableDelegate addSubscriber;
        //public SubscriberChangeVariableDelegate removeSubscriber;
